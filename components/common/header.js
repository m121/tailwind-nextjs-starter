        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <a
              ...
              href="/"
            >
              <img src="/img/logo.png" alt="logo minegocioqr" className="w-32" />
            </a>
            <button
          ...
          >
            ...
            {router.pathname !== '/' ? <Link href="/#planes"><a className={
              ...
              <Link href="/registro"><button style={{'backgroundColor': '#893bcc'}} class="inline-flex rounded-md text-white border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600  text-lg">Ingresar</button></Link>
                </li>
